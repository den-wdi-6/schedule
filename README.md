 ...
 **9:30am Module 1** | DAY | [**Lab: Full-Stack Books** - *Mongoose and Full-Stack JS*][5-2B] (Joe) | [**UX Crash Course** - *UX Ideation and Hierarchy of Needs*][5-3B] (Joe) | [**ShakeItSpeare API Testing** - *Node Requests and Mocha*][5-4B] (Zeb) | [**Intro to Bootstrap** - *Columns, Responsiveness, and More*][5-5C] (Joe)
