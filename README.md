...
**1:30pm Module 3** | [**Likes and Stores** - *Redux* (Tyler)  `redux`][11-2D] | [**React TODO** (Joe)  `react-todo-walkthrough-jquery`][11-2F] | [**Lab: Cars** - *PHP CRUD* (Zeb)  `php-crud`][11-5C] | [**Lab: Lightning Talk WP Site** - *PHP Wordpress* (Zeb)  `wordpress-lab`][11-4E] | [**Lightning Talks**][12-1C]
