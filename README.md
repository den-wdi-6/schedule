...
**1:30pm Module 3** | [**Callbacks & Iterators** - *forEach, map, filter, reduce* (Joe)][2-1D] | [**Doomed?, Music, and Color Picker** - *HTML Forms* (Joe)][2-2D] | [**Tweens and Rotating Greetings** - *CSS Transitions & Animations*][2-3D] (Tyler) | [**Wireframes** (Nick)][2-5E] | [**Lab: Tic Tac Toe Refactor** - *OOP* (Zeb)][2-4E]
**3:00pm Module 4** | [**Lab: Build Your Own Callbacks & Iterators** (Joe)][2-1E] | [**Lab: Mad Libs** - *CSS for HTML Forms* (Joe)][2-2E] | [**Lab: Tic-Tac-Toe** - *jQuery DOM Manipulation* (Joe)][2-3E] | [**Outcomes** (Nick)][2-4F] | [**CodeWars Intro**][2-5F] and [**Project 1 Intro**][2-5G] (Zeb)
