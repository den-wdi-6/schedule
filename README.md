...
**1:30pm Module 3** | [**Callbacks & Iterators** - *forEach, map, filter, reduce* (Joe)][2-1D] | [**Doomed?, Music, and Color Picker** - *HTML Forms* (Joe)][2-2D] | [**Tweens and Rotating Greetings** - *CSS Transitions & Animations*][2-3D] (Tyler) | [**Lab: Tic Tac Toe Refactor** - *OOP* (Zeb)][2-4E] | [**Wireframes** (Nick)][2-5E]
